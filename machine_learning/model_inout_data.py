...
class ModelInOutData():
    ...
    def get_dl_element3(self, source_data):
        if "転初" in source_data["transfer"]:
            return 1
        return 0
    def get_dl_element4(self,source_data):
        if "去初" in source_data["castration"]:
            return 1
        return 0
    def get_dl_element5(self, source_data):
        bi = '{:02b}'.format(self.util.get_class_rank(source_data["today_class"]))
        return int(bi[0])
    def get_dl_element6(self, source_data):
        bi = '{:02b}'.format(self.util.get_class_rank(source_data["today_class"]))
        return int(bi[1])
    def get_dl_element7(self, source_data):
        bi = '{:02b}'.format(self.util.get_class_rank(source_data["past_class"]))
        return int(bi[0])
    ...
    def get_dl_element11(self, source_data):
        return min(max(source_data["past_time_diff"],-2.5),2.5)
    ...
    def get_dl_element17(self, source_data):
        if self.util.get_class_priority(source_data["today_class"]) >= 2:
            return 1
        return 0
    ...
    def get_dl_element21(self, source_data):
        bi = '{:03b}'.format(min(source_data["horse_age"]-2,7))
        return int(bi[0])
    ...
    def get_dl_element24(self, source_data):
        single = [x for x in self.stallion if x['name']==source_data['stallion']]
        if len(single) == 0:
            return 0
        else:
    ...
    def get_dl_element37(self, source_data):
        if "[G001]" in source_data["today_course_mark"]:
            return 1
        return 0
    def get_dl_element38(self, source_data):
        if "[G002]" in source_data["today_course_mark"]:
            return 1
        return 0
    def get_dl_element39(self, source_data):
        if "[G003]" in source_data["today_course_mark"]:
            return 1
        return 0
    def get_dl_element40(self, source_data):
        if "[G004]" in source_data["today_course_mark"]:
            return 1
        return 0
    def get_dl_element41(self, source_data):
        if "[G005]" in source_data["today_course_mark"]:
            return 1
        return 0
    def get_dl_element42(self, source_data):
        if "[G006]" in source_data["today_course_mark"]:
            return 1
        return 0
    def get_dl_element43(self, source_data):
        if "[G007]" in source_data["today_course_mark"]:
            return 1
        return 0
    def get_dl_element44(self, source_data):
        if "[G008]" in source_data["today_course_mark"]:
            return 1
        return 0
    def get_dl_element45(self, source_data):
        if "[G009]" in source_data["today_course_mark"]:
            return 1
        return 0
    def get_dl_element46(self, source_data):
        if "[G010]" in source_data["today_course_mark"]:
            return 1
        return 0
    def get_dl_element47(self, source_data):
        if "[G011]" in source_data["today_course_mark"]:
            return 1
        return 0
    def get_dl_element48(self, source_data):
        if "[G012]" in source_data["today_course_mark"]:
            return 1
        return 0
    def get_dl_element49(self, source_data):
        if "[G013]" in source_data["today_course_mark"]:
            return 1
        return 0
    def get_dl_element50(self, source_data):
        if "[G014]" in source_data["today_course_mark"]:
            return 1
        return 0
    def get_dl_element51(self, source_data):
        if "[G015]" in source_data["today_course_mark"]:
            return 1
        return 0
    def get_dl_element52(self, source_data):
        if "[G016]" in source_data["today_course_mark"]:
            return 1
        return 0
    ...
    def get_dl_element92(self, source_data):
        return min(source_data["past_diff3f"],2.5)/2.5
    ...
    def get_dl_element95(self, source_data):
        if source_data["today_span"] <= 0:
            return 0
        else:
            return min(math.log(source_data["today_span"],2),8)/6
    ...
    def get_dl_element102(self, source_data):
        temperature = self.util.get_temperature(self.temperature, source_data)
